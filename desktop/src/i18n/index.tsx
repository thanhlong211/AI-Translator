...
const messages: Record<UiLocale, Record<string, string>> = {
    vi: {
        ...
        "settings.ocr.title": "Engine OCR",
        "settings.ocr.description": "Nhận dạng văn bản trên ảnh, manga và PDF quét.",
        "settings.ocr.ready": "Sẵn sàng",
        "settings.ocr.busy": "Đang nhận dạng",
        "settings.ocr.starting": "Đang khởi động",
        "settings.ocr.degraded": "Cần khởi động lại",
        "settings.ocr.stopped": "Chưa khởi động",
        "settings.ocr.unavailable": "Không khả dụng",
        "settings.ocr.runtimeFallback": "PaddleOCR sẽ được tải khi cần.",
        "settings.ocr.queuedSuffix": "tác vụ đang chờ",
        "settings.ocr.refresh": "Kiểm tra",
        "settings.ocr.checking": "Đang kiểm tra...",
        "settings.ocr.restart": "Khởi động lại OCR",
        "settings.ocr.restarting": "Đang khởi động lại...",
        "settings.ocr.problemHint": "OCR chưa sẵn sàng. Hãy khởi động lại engine; nếu vẫn lỗi, kiểm tra OCR runtime trong thư mục Desktop.",
    ...
    en: {
        ...
        "settings.ocr.title": "OCR engine",
        "settings.ocr.description": "Recognizes text in images, manga, and scanned PDFs.",
        "settings.ocr.ready": "Ready",
        "settings.ocr.busy": "Recognizing",
        "settings.ocr.starting": "Starting",
        "settings.ocr.degraded": "Restart required",
        "settings.ocr.stopped": "Not started",
        "settings.ocr.unavailable": "Unavailable",
        "settings.ocr.runtimeFallback": "PaddleOCR will load when needed.",
        "settings.ocr.queuedSuffix": "tasks waiting",
        "settings.ocr.refresh": "Check",
        "settings.ocr.checking": "Checking...",
        "settings.ocr.restart": "Restart OCR",
        "settings.ocr.restarting": "Restarting...",
        "settings.ocr.problemHint": "OCR is not ready. Restart the engine; if the problem continues, check the OCR runtime in the Desktop folder.",
